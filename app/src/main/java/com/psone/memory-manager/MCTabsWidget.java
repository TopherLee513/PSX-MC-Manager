...
public class MCTabsWidget extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		intent.putExtra("com.psone.memory-manager.FN", "No MC");
    	...
    	if(resultCode == RESULT_OK){
	    	...
	    	if(requestCode == 65535){
				 if(numTabs == 2){
					...
					passedFN = data.getStringExtra("com.psone.memory-manager.FN");
					intent = new Intent().setClass(this, MCViewActivity.class);
					intent.putExtra("com.psone.memory-manager.FN", passedFN);
	    	...
	    	if(requestCode == 65534){
	    		...
	    		alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
	    			public void onClick(DialogInterface dialog, int whichButton) {
	    				...
	    				String fn = intent.getStringExtra("com.psone.memory-manager.FN");
	    	    		if(fn!=null){
	    	    			try {
