...
public class MCTabsWidget extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		intent.putExtra("com.psone.memorymanager.FN", "No MC");
    	...
    	if(resultCode == RESULT_OK){
	    	...
	    	if(requestCode == 65535){
				 if(numTabs == 2){
					...
					passedFN = data.getStringExtra("com.psone.memorymanager.FN");
					intent = new Intent().setClass(this, MCViewActivity.class);
					intent.putExtra("com.psone.memorymanager.FN", passedFN);
	    	...
	    	if(requestCode == 65534){
	    		...
	    		//String fn = data.getStringExtra("com.psone.memorymanager.FN");
	    		intent = data;
	    		...
	    		alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
	    			public void onClick(DialogInterface dialog, int whichButton) {
	    				...
	    				String fn = intent.getStringExtra("com.psone.memorymanager.FN");
	    	    		if(fn!=null){
	    	    			try {
